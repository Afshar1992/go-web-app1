...
║  ├── 1. Run Project Locally (go run main.go)                                     ║
║  └── git push                                                                     ║
║       │                                                                           ║
║       ▼                                                                           ║
║  GitHub Repository                                                                 ║
...
║  └── 3. ArgoCD monitors repository for changes                                    ║
║       │                                                                           ║
║       ▼                                                                           ║
║  Docker Hub / ECR                                                                  ║
...
║                                                                                   ║
╠═══════════════════════════════════════════════════════════════════════════════════╣
║  ✅ DevOps Practices: CI | CD | Testing | Monitoring | Security | IaC | GitOps   ║
╚═══════════════════════════════════════════════════════════════════════════════════╝
---
